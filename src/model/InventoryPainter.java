		...
		for(int i=0;i<inventory.getMaxNbItem();i++) {
			if(inventory.getItem(i).getItemTypeId()!=0) {
				try {
					...
					crayon.drawImage(img_item, origin_x+MainPainter.inventory_tile_size*coord_tab_x+dec2, origin_y+MainPainter.inventory_tile_size*coord_tab_y+dec2, origin_x+MainPainter.inventory_tile_size*coord_tab_x+img_item_size+dec2, origin_y+MainPainter.inventory_tile_size*coord_tab_y+img_item_size+dec2, 0, 0, img_item_size,img_item_size, null);
				} catch (IOException e) {
